...
def get_escolha_coluna(tabuleiro_estado, jogador, profundidade, modo_jogo, lista_jogadas_predeterminadas):
    ...
    if modo_jogo == 2:
        color = "\033[1;34m" if jogador == "X" else "\033[1;31m"
        print(f"{color}Computador {jogador} está pensando...\033[0m")
        coluna, tempo = pc_escolher(tabuleiro_estado, profundidade)
        print(f"{color}Computador {jogador} escolheu coluna\033[0m \033[93m{coluna}\033[0m {color}em\033[0m \033[92m{tempo}\033[0m {color}segundos\033[0m")
        return coluna
    ...
    coluna, tempo = pc_escolher(tabuleiro_estado, profundidade)
    print(f"\033[1;31mComputador escolheu coluna\033[0m \033[93m{coluna}\033[0m \033[1;31mem\033[0m \033[92m{tempo}\033[0m \033[1;34msegundos\033[0m")
    return coluna
